    ...
    return (dispatch, getState) => {
        axios
            ...
            if (response && response.data) {
                ...
                dispatch(getBoardName(userInfo === null || userInfo === void 0 ? void 0 : userInfo.id));
            }
            else {
...
export const getTodoData = (userid) => {
    return (dispatch, getState) => {
        var _a, _b, _c, _d;
        if (((_b = (_a = getState().AddToDoReducers) === null || _a === void 0 ? void 0 : _a.boardData) === null || _b === void 0 ? void 0 : _b.length) > 0) {
            var boardId = ((_c = getState().AddToDoReducers) === null || _c === void 0 ? void 0 : _c.boardData) &&
                ((_d = getState().AddToDoReducers) === null || _d === void 0 ? void 0 : _d.boardData[0].id);
            if (sessionStorage.getItem("board_id") === null ||
                sessionStorage.getItem("board_id") === undefined ||
                sessionStorage.getItem("board_id") === "") {
                sessionStorage.setItem("board_id", boardId);
            }
            axios
                .get(`${BASE_URLS}/dashboard/getalltasks?boardId=${boardId}&userId=${userid}`)
                .then((response) => {
                if (response && response.data) {
...
export const removeBoard = (boardId) => {
    return (dispatch, getState) => {
        axios
            .delete(`${BASE_URLS}/dashboard/removeBoard?boardId=${boardId}`)
            .then((response) => {
